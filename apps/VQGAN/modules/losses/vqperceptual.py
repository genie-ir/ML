...
class VQLPIPSWithDiscriminator(nn.Module):
    ...
    def D12(self, x, l1=1, l2=1, flag=False, split=''):
        ...
        DoneLoss = -1 * (d1.log())
        DoneLoss.register_hook(lambda grad: self.d12grad(grad, split, f'!!!!!!! {DoneLoss.item()}'))
    ...
    def geometry(self, grandtrouth, prediction, split, pw=0.1, recln1p=False, landa1=1, hoo=False, losscontroller='Mean'): # pw=0.1
