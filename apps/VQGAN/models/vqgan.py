...
class VQModel(pl.LightningModule):
    ...
    def pipline(self, xs, Xc, 
        ...
        if y_edit_xc == '[01]': # 𝝍s_tp, xs ===> # Note: geometry loss
            ...
            if optidx == 0:
                ...
                B_loss2, B_loss2_logdict = self.loss.geometry(self.loss.Ro(Xc), R_𝝍s_tp, pw=0, split=split + 'B_Geo_Ro')
    ...
    def training_step_slave(self, batch, batch_idx, optimizer_idx, cidx, split='train_'):
        ...
        print('before SSSSSSSSSSSSSSSS', batch['ynl'], batch['ynl'][0][cidx], cidx)
        ynl = batch['ynl'][0][cidx] # I dont know why is a tuple!!
