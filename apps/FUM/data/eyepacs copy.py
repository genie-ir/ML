...
class D_DR(D_Base):
    def fetch(self, signal_path, **kwargs):
        ...
        # xc_np = [None for n in range(2)]
        xc_lesion = [None for n in range(2)]
        # xc_lesion_np = [None for n in range(2)]
        xc_cunvexhull = [None for n in range(2)] # binary
        xc_fundusmask = [None for n in range(2)] # binary
        Lmask_xc = [None for n in range(2)] # binary
